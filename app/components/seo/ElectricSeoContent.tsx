    ...
    <article className="space-y-10 text-slate-700 dark:text-slate-300 leading-relaxed text-sm sm:text-base">
      ...
      <section className="bg-slate-50 dark:bg-dark-card border border-slate-200 dark:border-dark-border p-6 sm:p-8 rounded-2xl space-y-4">
        ...
        <div className="space-y-3 font-mono text-xs sm:text-sm">
          <div className="p-3 bg-white dark:bg-dark-bg rounded-lg border border-slate-200 dark:border-dark-border">
          ...
          <table className="w-full border-collapse border border-slate-200 dark:border-dark-border text-xs sm:text-sm">
            <thead>
              <tr className="bg-slate-100 dark:bg-dark-bg text-slate-900 dark:text-slate-100 font-bold">
                <th className="border border-slate-200 dark:border-dark-border p-3 text-left">Appliance / Equipment</th>
                <th className="border border-slate-200 dark:border-dark-border p-3 text-left">Rated Wattage</th>
                <th className="border border-slate-200 dark:border-dark-border p-3 text-left">Typical Usage Profile</th>
                <th className="border border-slate-200 dark:border-dark-border p-3 text-left">Daily Energy</th>
                <th className="border border-slate-200 dark:border-dark-border p-3 text-left">Est. Monthly Cost</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-slate-200 dark:divide-dark-border">
              <tr>
                <td className="border border-slate-200 dark:border-dark-border p-3 font-semibold">Central Air Conditioner (3.5 Ton, 14 SEER)</td>
                <td className="border border-slate-200 dark:border-dark-border p-3 font-mono">3,500 W</td>
                <td className="border border-slate-200 dark:border-dark-border p-3">8 hours active cooling / day</td>
                <td className="border border-slate-200 dark:border-dark-border p-3 font-mono">28.0 kWh</td>
                <td className="border border-slate-200 dark:border-dark-border p-3 font-mono font-bold text-rose-600 dark:text-rose-400">$143.99 / mo</td>
              </tr>
              <tr>
                <td className="border border-slate-200 dark:border-dark-border p-3 font-semibold">Electric Vehicle (EV) Level 2 Home Charger</td>
                <td className="border border-slate-200 dark:border-dark-border p-3 font-mono">7,200 W (32A / 240V)</td>
                <td className="border border-slate-200 dark:border-dark-border p-3">2.5 hours / day (approx. 35 miles)</td>
                <td className="border border-slate-200 dark:border-dark-border p-3 font-mono">18.0 kWh</td>
                <td className="border border-slate-200 dark:border-dark-border p-3 font-mono font-bold text-rose-600 dark:text-rose-400">$92.56 / mo</td>
              </tr>
              <tr>
                <td className="border border-slate-200 dark:border-dark-border p-3 font-semibold">Electric Water Heater (50 Gallon Tank)</td>
                <td className="border border-slate-200 dark:border-dark-border p-3 font-mono">4,500 W</td>
                <td className="border border-slate-200 dark:border-dark-border p-3">3 hours heating element run / day</td>
                <td className="border border-slate-200 dark:border-dark-border p-3 font-mono">13.5 kWh</td>
                <td className="border border-slate-200 dark:border-dark-border p-3 font-mono font-bold text-amber-600 dark:text-amber-400">$69.42 / mo</td>
              </tr>
              <tr>
                <td className="border border-slate-200 dark:border-dark-border p-3 font-semibold">Portable Space Heater (Ceramic / Oil-filled)</td>
                <td className="border border-slate-200 dark:border-dark-border p-3 font-mono">1,500 W</td>
                <td className="border border-slate-200 dark:border-dark-border p-3">6 hours / day (High setting)</td>
                <td className="border border-slate-200 dark:border-dark-border p-3 font-mono">9.0 kWh</td>
                <td className="border border-slate-200 dark:border-dark-border p-3 font-mono font-bold text-amber-600 dark:text-amber-400">$46.19 / mo</td>
              </tr>
              <tr>
                <td className="border border-slate-200 dark:border-dark-border p-3 font-semibold">Electric Clothes Dryer</td>
                <td className="border border-slate-200 dark:border-dark-border p-3 font-mono">3,000 W</td>
                <td className="border border-slate-200 dark:border-dark-border p-3">1 hour / day (approx. 1 load)</td>
                <td className="border border-slate-200 dark:border-dark-border p-3 font-mono">3.0 kWh</td>
                <td className="border border-slate-200 dark:border-dark-border p-3 font-mono font-bold text-slate-700 dark:text-slate-300">$15.40 / mo</td>
              </tr>
              <tr>
                <td className="border border-slate-200 dark:border-dark-border p-3 font-semibold">Gaming Desktop PC (GPU + Multi-Monitor)</td>
                <td className="border border-slate-200 dark:border-dark-border p-3 font-mono">500 W</td>
                <td className="border border-slate-200 dark:border-dark-border p-3">5 hours active load / day</td>
                <td className="border border-slate-200 dark:border-dark-border p-3 font-mono">2.5 kWh</td>
                <td className="border border-slate-200 dark:border-dark-border p-3 font-mono font-bold text-slate-700 dark:text-slate-300">$12.83 / mo</td>
              </tr>
              <tr>
                <td className="border border-slate-200 dark:border-dark-border p-3 font-semibold">Energy Star Refrigerator (French Door, 25 cu ft)</td>
                <td className="border border-slate-200 dark:border-dark-border p-3 font-mono">150 W</td>
                <td className="border border-slate-200 dark:border-dark-border p-3">8 hours compressor run (33% duty cycle)</td>
                <td className="border border-slate-200 dark:border-dark-border p-3 font-mono">1.2 kWh</td>
                <td className="border border-slate-200 dark:border-dark-border p-3 font-mono font-bold text-emerald-600 dark:text-emerald-400">$6.16 / mo</td>
              </tr>
              <tr>
                <td className="border border-slate-200 dark:border-dark-border p-3 font-semibold">Smart TV (65-inch 4K OLED)</td>
                <td className="border border-slate-200 dark:border-dark-border p-3 font-mono">120 W</td>
                <td className="border border-slate-200 dark:border-dark-border p-3">5 hours viewing / day</td>
                <td className="border border-slate-200 dark:border-dark-border p-3 font-mono">0.6 kWh</td>
                <td className="border border-slate-200 dark:border-dark-border p-3 font-mono font-bold text-emerald-600 dark:text-emerald-400">$3.08 / mo</td>
              </tr>
              <tr>
                <td className="border border-slate-200 dark:border-dark-border p-3 font-semibold">Standby &amp; Vampire Loads (Whole House Idle)</td>
                <td className="border border-slate-200 dark:border-dark-border p-3 font-mono">100 W (Continuous)</td>
                <td className="border border-slate-200 dark:border-dark-border p-3">24 hours / day (modems, smart devices, clocks)</td>
                <td className="border border-slate-200 dark:border-dark-border p-3 font-mono">2.4 kWh</td>
                <td className="border border-slate-200 dark:border-dark-border p-3 font-mono font-bold text-amber-600 dark:text-amber-400">$12.32 / mo</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <section className="space-y-4">
        ...
        <div className="space-y-3">
          <div className="p-4 rounded-xl border border-slate-200 dark:border-dark-border bg-white dark:bg-[#1f2127]">
      ...
      <section className="bg-slate-50 dark:bg-dark-card border border-slate-200 dark:border-dark-border p-6 sm:p-8 rounded-2xl space-y-4">
        ...
        <div className="p-4 bg-white dark:bg-dark-bg rounded-lg border border-slate-200 dark:border-dark-border font-mono text-xs sm:text-sm text-primary dark:text-sky-400 font-bold">
