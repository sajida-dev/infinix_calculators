          ...
          <table className="w-full border-collapse border border-slate-200 dark:border-dark-border text-xs sm:text-sm">
            <thead>
              <tr className="bg-slate-100 dark:bg-dark-bg text-slate-900 dark:text-slate-100">
                <th className="border border-slate-200 dark:border-dark-border p-3 text-left">Phase</th>
                <th className="border border-slate-200 dark:border-dark-border p-3 text-left">Duration</th>
                <th className="border border-slate-200 dark:border-dark-border p-3 text-left">Monthly Payment</th>
                <th className="border border-slate-200 dark:border-dark-border p-3 text-left">Principal Reduction</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td className="border border-slate-200 dark:border-dark-border p-3 font-semibold">Draw Period (Interest-Only)</td>
                <td className="border border-slate-200 dark:border-dark-border p-3">Years 1–10</td>
                <td className="border border-slate-200 dark:border-dark-border p-3 font-mono font-bold">$354.17 / mo</td>
                <td className="border border-slate-200 dark:border-dark-border p-3 text-rose-500 font-bold">$0 (Zero)</td>
              </tr>
              <tr>
                <td className="border border-slate-200 dark:border-dark-border p-3 font-semibold">Repayment (15-yr Amortization)</td>
                <td className="border border-slate-200 dark:border-dark-border p-3">Years 11–25</td>
                <td className="border border-slate-200 dark:border-dark-border p-3 font-mono font-bold text-rose-600">$492.38 / mo</td>
                <td className="border border-slate-200 dark:border-dark-border p-3 text-emerald-600 font-bold">Full $50,000 paid off</td>
              </tr>
            </tbody>
          </table>
        </div>
