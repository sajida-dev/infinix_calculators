...
export const calculatorsData: Record<string, CalculatorInfo> = {
  ...
  cbm: {
    ...
    seoTitle: "CBM Calculator - Cubic Meter Shipping Formula (Inches, CM, Feet & Weight)",
    metaDescription: "Free CBM calculator for freight shipping & cargo containers. Convert dimensions (cm, inches, ft) to cubic meters (m³), calculate sea freight weight & 20ft/40ft container fit.",
    keywords: [
      "cbm calculator",
  ...
  "mortgage-calculator-game": {
    ...
    metaDescription: "Play our free interactive mortgage calculator game! Learn home buying, amortization schedules, down payments, extra principal payoffs, and interest savings score.",
    keywords: [
      "mortgage calculator game",
