...
export const calculatorsData: Record<string, CalculatorInfo> = {
  ...
  topsoil: {
    ...
    seoTitle: "Topsoil Calculator [2026] - Cost Per Yard, Dirt Delivery & Bags Near Me",
    metaDescription: "Calculate exact topsoil yards, tons, and bags (0.75 cu ft) near me. Includes bulk dirt delivery prices ($25-$55/yd), 10-15% compaction buffer, and lawn depth math.",
    keywords: [
      "topsoil calculator",
      "top soil calculator",
      "top soil near me",
      "topsoil near me",
      "top soil for sale near me",
      "topsoil delivery near me",
      "bulk topsoil near me",
      "cost of top soil per yard",
  ...
  cbm: {
    ...
    seoTitle: "CBM Calculator: Convert CM, MM, Inches & Feet to Cubic Meters",
    metaDescription: "Calculate CBM from shipping dimensions in cm, mm, inches, feet, or meters. Get total cubic meters, cubic feet, carton volume, and freight weight estimates.",
    keywords: [
      "cbm calculator",
      ...
      "dimension to cbm",
      "cubic m calculator",
      "work out cubic metres",
      "cbm conversion calculator",
      "meter to cbm",
      "cbm in inches formula",
      "cbm formula in inches",
      "cm to cbm converter",
      ...
      "how to work out cubic meters",
      "how to calculate a cubic metre",
      "how to determine cubic meters",
      ...
      "how to compute for cbm",
      "calculate cbm from inches",
      "calculate cbm from cm",
      "cbm calculator from inches",
      "cbm calculator ginifab",
      ...
      "inch to cbm formula",
      "mm to cbm",
      "mm to cbm calculator",
      "inches to cbm",
      "convert cm to cbm",
      "cbm calculation formula",
      "cbm calculation formula in cm",
      "how to calculate cbm in cm",
      "how to calculate cbm in inches",
      "how to calculate cbm from cm",
      "how to calculate cbm from inches",
      "volume cbm",
      "cbm to meter",
      "meters cubed calculator",
      "metres cubed calculator",
      "cbm calculator by dimensions",
      "calculator cubic meters",
      "cubic meter formula",
      "1 cbm size"
    ],
  ...
  affirm: {
    ...
    keywords: [
      ...
      "affirm interest calculator",
      "affirm loan calculator",
      "affirm estimate payment",
      "free affirm calculator",
      "affirm estimate calculator",
      "affirm price calculator",
      "affirm down payment calculator",
      "affirm payment plans calculator",
      "affirm apr calculator",
      "how much would i pay on a pay in affirm 4 plan on a 375 dollar order",
      "affirm early payoff calculator",
      ...
      "affirm rates calculator",
      "free affirm calculator for customers",
      "estimate affirm payments"
    ],
  ...
  "pro-rata": {
    ...
    category: "financial",
    categoryLabel: "Financial Calculators",
    seoTitle: "Pro Rata Calculator - Calculate Prorated Rent, Salary & Daily Rates",
    metaDescription: "Free pro rata calculator. Calculate prorated rent, salary, moving day adjustments, and monthly billing cycles using 365-day and 360-day banker's formulas.",
    keywords: [
      "pro rata calculator",
      "pro-rata calculator",
      "prorata calculator",
  ...
  roof: {
    ...
    category: "construction",
    categoryLabel: "Construction & Materials",
    seoTitle: "Roof Shingle Calculator - Estimate Squares, Bundles, Pitch & Cost",
    metaDescription: "Free roof shingle estimator. Calculate roofing squares, bundles of shingles needed, roof pitch slope multipliers, waste factors, and replacement cost per square.",
    keywords: [
      "shingle calculator",
      ...
      "davinci roof calculator",
      "square of shingles calculator",
      "roof calculator for shingles",
  ...
  concrete: {
    ...
    metaDescription: "Free concrete calculator for slabs, footings, patios & steps. Calculate cubic yards, ready-mix price per yard, and how many 80lb/60lb bags of concrete you need instantly.",
    keywords: [
      "concrete calculator",
      ...
      "concrete delivery cost per yard",
      "concrete cube calculator",
      "concrete path calculator",
      "concrete estimator",
      "concrete measurements calculator",
      ...
      "how to figure concrete volume",
      "how to figure concrete calculator",
      "how to estimate concrete",
      "how to calculate concrete",
      "how to calculate how much concrete you need",
      "how to calculate how much cement i need",
      "calculating cement",
      "calculate cement",
      "readymix calculator",
  ...
  "balance-transfer": {
    ...
    keywords: [
      ...
      "0 apr balance transfer fee calculation",
      "work out balance transfer fee"
    ],
  ...
  "square-fee": {
    ...
    category: "financial",
    categoryLabel: "Financial Calculators",
    seoTitle: "Square Fee Calculator - Credit Card & Invoice Processing Fees (2026)",
    brandDisclaimer: "This calculator is an independent estimation tool based on publicly available merchant rates. It is not affiliated with, sponsored by, or endorsed by Square, Inc. or Block, Inc.",
    metaDescription: "Calculate exact Square transaction fees (2.6% + 10¢ in-person, 2.9% + 30¢ online, 3.3% + 30¢ invoices). Gross up invoices to receive 100% of your payout without hidden deductions.",
    keywords: [
      ...
      "what percentage does square charge",
      "square transaction fee calculator",
      "squareup fee calculator",
      "square payment calculator",
      "what does square charge per transaction",
      "what is the transaction fee for square",
      "square payment processing fees",
      "squareup calculator",
      "square app fee calculator",
      "square invoice fee calculator",
  ...
  "avalara-sales-tax": {
    ...
    keywords: [
      ...
      "avalara 94105 sales tax rate",
      "avalara tax rate lookup",
      "avalara sales tax",
      "sales tax calculator avalara",
      "avalara tax rates",
      "avalara sales tax by state",
      "avalara sales tax lookup",
      "avalara sales tax calculator by address",
      "avalara us sales tax calculator",
      "avalara avatax pricing",
      "avalara sales tax rate 15204",
      "avalara sales tax rate lookup",
      "avalara calculator",
      "avalara pricing",
      "avatax pricing",
      "avalara tax rate calculator",
      "avalara sales tax pricing",
      "avalara tax calculator by address",
      "avalara 94105 sales tax rate 2026",
      "94105 sales tax rate avalara",
      "avalara sales tax rates",
      "avalara sales tax lookup by address",
  ...
  "lsat-score-calculator": {
    ...
    keywords: [
      ...
      "official lsat score conversion",
      "lsat scaled score",
      "lsat raw score",
      "lsat raw score calculator",
      "lsat raw score converter",
      "lsat raw score conversion guide",
      "convert raw lsat score",
      "lsat scoring scale",
      "how to convert raw score to scaled lsat",
      "lsat demon score calculator",
      "lsat demon score converter",
      "lsat percentile calculator",
      "lsat grade calculator",
      "lsat score estimator",
      "how to calculate my lsat score",
      "calculate lsat score",
      "lsat score calc",
      "score converter lsat",
      "score conversion lsat",
      "free lsat score calculator",
      "lsat flex score calculator",
      "what is a good lsat score",
      "what is an elite lsat score",
  ...
  productivity: {
    ...
    keywords: [
      ...
      "how to compute labor productivity",
  ...
  "therapy-productivity": {
    ...
    keywords: [
      ...
      "snf productivity calculator",
      "productivity calculator for physical therapists",
      "productivity with lunch break calculator",
      "therapy productivity calculator 30 minute lunch",
      "therapist calculator",
      "therapy calculator",
      "productivity calculator for therapists",
      "snf productivity calculator",
  ...
  "google-review": {
    ...
    category: "math",
    categoryLabel: "Math & Business Productivity",
    seoTitle: "Google Review Rating Calculator - How Many 5-Star Reviews to Reach 4.8?",
    metaDescription: "Free Google review calculator: find how many 5-star reviews you need to raise your rating to 4.8 or 5.0. Enter your current stars & review count for instant math.",
    keywords: [
      ...
      "google rating boost calculator",
      "google review math formula",
      "how to get 4.8 stars on google"
    ],
  ...
  "dog-pregnancy": {
    ...
    keywords: [
      ...
      "dog pregnancy due date",
      "whelping calculator",
      "canine gestation calculator",
      "dog gestation calculator",
      "dog gestation period calculator",
      "pregnancy calculator dog",
      "pregnant dog calculator",
      "pregnancy calculator for dogs",
  ...
  "novig": {
    ...
    metaDescription: "Calculate no-vig fair odds, true implied probability, and sportsbook vig/overround for sports betting. Devig 2-way American odds instantly.",
    keywords: [
      "novig calculator",
      "no vig calculator",
      "no-vig calculator",
      "novig odds calculator",
      "fair odds calculator",
      "betting fair odds calculator",
      "remove juice calculator",
      "remove vig calculator",
      "devig calculator",
      "devigger",
      "true probability sports betting",
      "implied probability calculator sports",
  ...
  "global-surgery": {
    ...
    keywords: [
      ...
      "global calculator surgery",
      "global surgery billing calculator",
      "cpt post-op global days finder",
      "medicare global surgery calculator",
      "cpt global period lookup",
      "90 day global period calculator",
      "10 day global period calculator",
      "global surgical package calculator",
      "post op global days calculator"
    ],
  ...
  "529-growth": {
    ...
    keywords: [
      ...
      "529 tax savings estimator",
      "college education investment",
  ...
  "pink-calculator": {
    ...
    category: "math",
    categoryLabel: "Math & Business Productivity",
    seoTitle: "Pink Calculator Online Free (2026) – Cute Aesthetic Pastel Calculator & Scientific Math",
    metaDescription: "Free online pink aesthetic calculator with 4 pastel themes, retro click sounds, scientific math (tan⁻¹, log, π), tape history, and keyboard shortcuts.",
    keywords: [
      ...
      "aesthetic calculator online",
      "aesthetic calculator online free",
      "cute calculator online aesthetic",
      "online pink calculator",
      "aesthetic calculator website",
      "calculadora aesthetic online",
      "pink calculator online free",
      "pink calculator",
  ...
  "3d-printing-cost": {
    ...
    category: "math",
    categoryLabel: "Math & Business Productivity",
    seoTitle: "3D Printing Cost Calculator - Filament, Power & Wear Estimator",
    metaDescription: "Calculate exact 3D print production costs. Compute PLA/PETG/ABS filament weight cost, electricity consumption, machine wear depreciation, and failure rate markup.",
    keywords: ["3d printing cost calculator", "3d print pricing calculator", "filament cost calculator", "bambu lab print cost", "3d printer power consumption"],
    hook: "Estimate 3D Print Material, Electricity & Machine Depreciation Costs Instantly.",
    description: "Input filament weight in grams, spool price, print duration, and electricity rates to calculate exact manufacturing unit costs and retail customer pricing quotes.",
    calcTime: "1 min",
    ...
    useCases: [
      "Etsy 3D print product pricing",
      "Bambu Lab / Creality filament cost estimation",
      "Commercial print farm job quotes"
    ],
    tips: [
      "Factor in a 10% to 15% failure rate buffer to account for nozzle clogs and bed adhesion failures."
    ],
    inputs: [
      { id: "filamentWeight", label: "Filament Used (Grams)", type: "number", defaultValue: 150, unit: "g" },
      { id: "spoolCost", label: "Spool Cost ($ per kg)", type: "number", defaultValue: 20, unit: "$" },
      { id: "printTime", label: "Print Duration (Hours)", type: "number", defaultValue: 5, unit: "hrs" },
      { id: "wattage", label: "Printer Power Draw (Watts)", type: "number", defaultValue: 150, unit: "W" },
      { id: "electricityRate", label: "Electricity Cost ($ per kWh)", type: "number", defaultValue: 0.15, unit: "$/kWh" },
      { id: "printerCost", label: "Printer Purchase Price ($)", type: "number", defaultValue: 600, unit: "$" },
      { id: "failureBuffer", label: "Failed Print Buffer (%)", type: "number", defaultValue: 10, unit: "%" },
      { id: "markup", label: "Target Profit Markup (%)", type: "number", defaultValue: 50, unit: "%" }
    ],
    calculate: (inputs) => {
      const weightG = Number(inputs.filamentWeight || 0);
      const spoolPrice = Number(inputs.spoolCost || 0);
      const hours = Number(inputs.printTime || 0);
      const watts = Number(inputs.wattage || 0);
      const kwhRate = Number(inputs.electricityRate || 0);
      const machinePrice = Number(inputs.printerCost || 0);
      const buffer = Number(inputs.failureBuffer || 0);
      const markup = Number(inputs.markup || 0);

      const filamentCost = (weightG / 1000) * spoolPrice;
      const powerCost = (watts / 1000) * hours * kwhRate;
      const depreciationCost = (machinePrice / 3000) * hours; // assumes 3,000 hr printer lifespan
      const rawCost = filamentCost + powerCost + depreciationCost;
      const totalCostWithBuffer = rawCost * (1 + buffer / 100);
      const quotePrice = totalCostWithBuffer * (1 + markup / 100);
      const profitAmount = quotePrice - totalCostWithBuffer;

      return {
        unitCost: { value: `$${totalCostWithBuffer.toFixed(2)}`, label: "Production Cost (incl. 10% buffer)", unit: "" },
        clientQuote: { value: `$${quotePrice.toFixed(2)}`, label: "Recommended Quote Price", unit: "" },
        filamentShare: { value: `$${filamentCost.toFixed(2)}`, label: "Filament Material Cost", unit: "" },
        powerShare: { value: `$${powerCost.toFixed(2)}`, label: "Electricity Cost", unit: "" },
