...
export const calculatorsData: Record<string, CalculatorInfo> = {
  ...
  cbm: {
    ...
    seoTitle: "CBM Calculator - How to Calculate Cubic Meters for Shipping (2026)",
    metaDescription: "Free CBM calculator 2026: convert cm, inches & feet to cubic meters (m³), calculate cargo volume & chargeable weight. Includes 20ft/40ft container capacity and CBM-to-kg formula.",
    keywords: [
      "cbm calculator",
  ...
  affirm: {
    ...
    seoTitle: "Affirm Payment Calculator - Monthly Payment, 0% APR & Pay in 4",
    ...
    metaDescription: "Free Affirm payment calculator. Estimate monthly payments, Pay in 4 bi-weekly schedule, simple interest costs, down payments, and 0% APR financing with zero credit score impact.",
    keywords: [
      "affirm calculator",
  ...
  "avalara-sales-tax": {
    ...
    seoTitle: "Avalara Sales Tax Calculator 2026 - Rate Lookup by ZIP Code (94105)",
    ...
    metaDescription: "Free Avalara sales tax calculator 2026: look up combined state & local tax rates by ZIP (94105 San Francisco, 10001 NYC), calculate checkout totals & reverse sales tax in seconds.",
    keywords: [
  ...
  "mortgage-calculator-game": {
    ...
    category: "education",
    categoryLabel: "Education & GPA",
    seoTitle: "Mortgage Calculator Game [2026] - Interactive Home Loan Simulator",
    metaDescription: "Play the viral Mortgage Calculator Game! Simulate 30-year homebuying, test 7% interest rates, PMI elimination, extra principal payoffs, and boost your Savings Score.",
    keywords: [
      "mortgage calculator game",
