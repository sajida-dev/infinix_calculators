...
export default function AboutPage() {
  return (
    <section className="max-w-4xl mx-auto py-12 px-4 text-slate-900 dark:text-slate-100 transition-colors">
      <h1 className="text-4xl font-extrabold text-primary dark:text-sky-400 mb-6">About Infinix Calculators</h1>
      ...
      <h2 className="text-2xl font-bold text-primary dark:text-sky-400 mt-8 mb-4">Why Choose Us?</h2>
